...
auto Curve::evaluator(InterpMode mode) const -> CurveEvaluator {
    switch (mode) {
    case InterpMode::Wachpress:
        return evaluator(InterpParameters<InterpMode::Wachpress>{});
    case InterpMode::MeanValue:
        return evaluator(InterpParameters<InterpMode::MeanValue>{});
    case InterpMode::GaussianRBF:
        return evaluator(InterpParameters<InterpMode::GaussianRBF>{});
    case InterpMode::SplineGaussianRBF:
        return evaluator(InterpParameters<InterpMode::SplineGaussianRBF>{});
    case InterpMode::DesbrunSplineRBF:
        return evaluator(InterpParameters<InterpMode::DesbrunSplineRBF>{});
    }
    return evaluator(InterpParameters<InterpMode::Wachpress>{});
}
