...
namespace mtao::opengl {
    ...
    template <typename ShaderType>
        class Drawable: public DrawableType<ShaderType> {
        public:
            explicit Drawable(objects::Mesh& mesh, ShaderType& shader, SceneGraph::DrawableGroup3D& group): SceneGraph::Drawable3D{mesh, &group},  _mesh(mesh),_shader(shader) {}
            void gui();
        ...
        private:
            ...
            void set_matrices(const Matrix4& transformationMatrix, SceneGraph::Camera3D& camera)  {
