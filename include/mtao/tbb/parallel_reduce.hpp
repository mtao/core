    ...
    class rvalue_lambda_reduce_body {
      ...
      public:
        rvalue_lambda_reduce_body(const Value &identity, const RealBody &body, const Reduction &reduction)
          : identity_element(identity), my_real_body(body), my_reduction(reduction), my_value(identity) {}
        rvalue_lambda_reduce_body(const rvalue_lambda_reduce_body &other)
          : identity_element(other.identity_element), my_real_body(other.my_real_body), my_reduction(other.my_reduction), my_value(other.my_value) {}
        rvalue_lambda_reduce_body(rvalue_lambda_reduce_body &other, ::tbb::split)
          : identity_element(other.identity_element), my_real_body(other.my_real_body), my_reduction(other.my_reduction), my_value(other.identity_element) {}
...
Value parallel_reduce(const Range &range, const Value &identity, const RealBody &real_body, const Reduction &reduction) {
    ...
    ::tbb::internal::start_reduce<Range, BodyType, const ::tbb::auto_partitioner>::run(range, body, ::tbb::auto_partitioner());
    return body.result();
}
}// namespace mtao::tbb
