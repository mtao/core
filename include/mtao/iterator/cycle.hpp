...
namespace detail {
    ...
    struct cycle_container {
      public:
        struct CycleIt {
          public:
            CycleIt(const cycle_container *c, const BeginIt &it)
              : m_container(c), m_it(it) {}
    ...
    struct cycle_container_with_offset : public cycle_container<BeginIt, EndIt> {
        ...
        using Base::Base;
        cycle_container_with_offset(BeginIt &&b, EndIt &&e, size_t offset)
          : Base(std::forward<BeginIt>(b), std::forward<EndIt>(e)),
            m_offset(offset) {}
...
template<typename BeginIt, typename EndIt>
auto cycle(BeginIt &&b, EndIt &&e) {
    return detail::cycle_container<BeginIt, EndIt>(std::forward<BeginIt>(b),
                                                   std::forward<EndIt>(e));
}
template<typename Container>
auto cycle(Container &&c) {
...
template<typename BeginIt, typename EndIt>
auto cycle_with_offset(BeginIt &&b, EndIt &&e, size_t offset) {
    return detail::cycle_container_with_offset<BeginIt, EndIt>(
      std::forward<BeginIt>(b), std::forward<EndIt>(e), offset);
}
template<typename Container>
auto cycle_with_offset(Container &&c, size_t offset) {
