...
template<typename T>
std::tuple<mtao::ColVectors<T, 3>, mtao::ColVecs3i> arrow(const mtao::ColVectors<T, 3> &P, double cone_radius, int N = 5, double arrow_radius_scale = 1.5, double tip_scale = 1.) {
