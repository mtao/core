...
namespace mtao::geometry::interpolation {
    ...
    //The common flag "make_pou" detrmines whether a RBF should be assumed to be a partition of unity
    ...
    template <typename PointsType, typename VecType>
        auto  gaussian_rbf(const Eigen::MatrixBase<PointsType>& P, const Eigen::MatrixBase<VecType>& v, typename PointsType::Scalar radius, bool make_pou=false) {
            using Scalar = typename PointsType::Scalar;
    ...
    template <typename PointsType, typename VecType>
        auto  spline_gaussian_rbf(const Eigen::MatrixBase<PointsType>& P, const Eigen::MatrixBase<VecType>& v, typename PointsType::Scalar radius, bool make_pou=false) {
            using Scalar = typename PointsType::Scalar;
            auto R = radial_basis_function(
                    [](Scalar v) -> Scalar { 
                    if(v < 1) {
    ...
    template <typename PointsType, typename VecType>
        auto  desbrun_spline_rbf(const Eigen::MatrixBase<PointsType>& P, const Eigen::MatrixBase<VecType>& v, typename PointsType::Scalar radius, bool make_pou=false) {
            using Scalar = typename PointsType::Scalar;
            auto R = radial_basis_function(
                    [](Scalar v) -> Scalar { 
                    if(v < 2) {
    ...
    template <typename PointsType, typename VecType>
        auto  gaussian_rbg(const Eigen::MatrixBase<PointsType>& P, const Eigen::MatrixBase<VecType>& v, typename PointsType::Scalar radius) {
            using Scalar = typename PointsType::Scalar;
            auto R = radial_basis_function(
                    [](Scalar v) -> Scalar { return - v * std::exp(-.5 * v * v); },
                    P,v,radius);
            R /= (std::sqrt(2 * M_PI) * radius);
            return R;
        }
    ...
    template <typename PointsType, typename VecType>
        auto  spline_gaussian_rbg(const Eigen::MatrixBase<PointsType>& P, const Eigen::MatrixBase<VecType>& v, typename PointsType::Scalar radius) {
            using Scalar = typename PointsType::Scalar;
            auto R = radial_basis_function(
                    [](Scalar v) -> Scalar { 
                    if(v < 1) {
    ...
    template <typename PointsType, typename VecType>
        auto  desbrun_spline_rbg(const Eigen::MatrixBase<PointsType>& P, const Eigen::MatrixBase<VecType>& v, typename PointsType::Scalar radius) {
            using Scalar = typename PointsType::Scalar;
            auto R = radial_basis_function(
                    [](Scalar v) -> Scalar { 
                    if(v < 2) {
