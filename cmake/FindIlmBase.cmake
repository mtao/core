...
if(EXISTS "${IlmBase_INCLUDE_DIR}/IlmBaseConfig.h")
    ...
    # See if we are dealing with gentoo multilib BS
    set(IlmBase_CONFIG_HEADER "${IlmBase_INCLUDE_DIR}/IlmBaseConfig.h")
    file(STRINGS "${IlmBase_CONFIG_HEADER}"
        _ilmbase_redirect_path REGEX "include <"
  )
  if(ilmbase_redirect_path STREQUAL "")
  else()
  string(REGEX REPLACE ".*<" ""
    _ilmbase_redirect_path "${_ilmbase_redirect_path}"
  )
  string(REGEX REPLACE ">.*" ""
      _ilmbase_redirect_path "${_ilmbase_redirect_path}"
  )
  set(IlmBase_CONFIG_HEADER "${IlmBase_INCLUDE_DIR}/../${_ilmbase_redirect_path}")
  unset(_ilmbase_redirect_path)
  endif()
