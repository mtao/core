...
TEST_CASE("2d_nocol", "[stack_meshes]") {
        ...
        tups.emplace_back(
                ...
                mtao::ColVecs3i::Constant(3,1,0));
        tups.emplace_back(
                mtao::ColVecs2d::Constant(2,1,1.0),
                mtao::ColVecs3i::Constant(3,2,1));
        tups.emplace_back(
                mtao::ColVecs2d::Constant(2,3,2.0),
                mtao::ColVecs3i::Constant(3,3,2));
...
TEST_CASE("2d_col", "[stack_meshes]") {
        ...
        tups.emplace_back(
                mtao::ColVecs2d::Constant(2,4,0.0),
                mtao::ColVecs3i::Constant(3,1,0), mtao::Vec4d::Zero());
        tups.emplace_back(
                mtao::ColVecs2d::Constant(2,1,1.0),
                mtao::ColVecs3i::Constant(3,2,1), mtao::Vec4d::Ones());
        tups.emplace_back(
                mtao::ColVecs2d::Constant(2,3,2.0),
                mtao::ColVecs3i::Constant(3,3,2), mtao::Vec4d::Zero());
...
TEST_CASE("2d_col_single_vel", "[stack_meshes]") {
        ...
        tups.emplace_back(
                mtao::ColVecs3i::Constant(3,1,0), mtao::Vec4f::Zero());
        tups.emplace_back(
                mtao::ColVecs3i::Constant(3,2,1), mtao::Vec4f::Ones());
        tups.emplace_back(
                mtao::ColVecs3i::Constant(3,3,2), mtao::Vec4f::Zero());
...
TEST_CASE("2d_col_single_vel2", "[stack_meshes]") {
        std::vector<std::tuple<mtao::ColVecs2i, mtao::Vec4f>> tups;
        ...
        tups.emplace_back(
                mtao::ColVecs2i::Constant(2,1,0), mtao::Vec4f::Zero());
        tups.emplace_back(
                mtao::ColVecs2i::Constant(2,2,1), mtao::Vec4f::Ones());
        tups.emplace_back(
                mtao::ColVecs2i::Constant(2,3,2), mtao::Vec4f::Zero());
